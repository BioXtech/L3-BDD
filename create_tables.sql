...
CREATE TABLE SUBSCRIPTION_TYPES(
	...
	COST_PER_MONTH FLOAT(4,2) NOT NULL,
...
CREATE TABLE CUSTOMER(
	...
	FIRST_NAME VARCHAR NOT NULL,
	LAST_NAME VARCHAR NOT NULL,
	POSTAL_ADRESS VARCHAR NOT NULL,
...
CREATE TABLE VIDEO_FORMAT(
	...
	NAME_VIDEO_FORMAT VARCHAR NOT NULL,
...
CREATE TABLE RENTING(
	...
	CONSTRAINT FK_RENTING_CONTENT FOREIGN KEY(CONTENT) REFERENCES CONTENT(CONTENT_ID)
);
...
CREATE TABLE LINK_CUSTOMER_RENTING(
	...
	CONSTRAINT FK_LINK_CUSTOMER FOREIGN KEY(CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID),
	CONSTRAINT FK_LINK_RENT FOREIGN KEY(RENT_ID) REFERENCES RENTING(RENT_ID)
);
...
CREATE TABLE PURCHASE(
	...
	CONSTRAINT FK_PURCHASE_FORMAT FOREIGN KEY(VIDEO_FORMAT) REFERENCES VIDEO_FORMAT(FORMAT_ID)
);
...
CREATE TABLE LINK_CUSTOMER_PURCHASE(
	...
	CONSTRAINT FK_LINK_CUSTOMER FOREIGN KEY(CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID),
	CONSTRAINT FK_LINK_PURCHASE FOREIGN KEY(PURCHASE_ID) REFERENCES PURCHASE(PURCHASE_ID)
);
...
CREATE TABLE PEGI_RATING(
	...
	CONSTRAINTS PK_PEGI_RATING PRIMARY KEY(PEGI_RATING_ID)
);
...
CREATE TABLE CONTENT(
	...
	CONTENT_DIRECTOR VARCHAR NOT NULL,
	TRAILER_LINK VARCHAR NOT NULL,
	...
	CONSTRAINT PK_CONTENT_SHOW FOREIGN KEY(SHOW_ID) REFERENCES SHOW(SHOW_ID)
);
